        ...
        <div class="box">
            <div class="box-header with-border">
                ...
                <div class="box-tools pull-right">
                    <a href="{{ route('penjualan.daily_sales_pdf', ['date' => $selectedDate]) }}" class="btn btn-success btn-flat" target="_blank">
                        <i class="fa fa-download"></i> Download PDF
                    </a>
                </div>
            </div>
            <div class="box-body">
                <form method="GET" action="{{ route('penjualan.daily_sales') }}" id="filter-form">
                    <div class="row">
                        <div class="col-md-4">
